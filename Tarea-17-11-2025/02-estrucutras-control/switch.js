...
// Si se usa var dentro de un case sin llaves, la variable se elevaría (hoisting) al scope del switch completo
// y sería accesible en todos los cases, creando posibles conflictos
switch (opcion) {
    case 1: {
        // var mensajeVar = "Con var no hay Block Scope";  // Con var se elevaría al scope del switch
